...
import com.ibm.space.collision.CollectionCircuitBreakers;
...
public class Collision {
	...
	public static String[] urls = { "http://" + System.getProperty("enemyip", "127.0.0.1:9082") + "/enemy-1.0/", 
									"http://" + System.getProperty("playerip" , "127.0.0.1:9082") + "/player-1.0/",
									"http://" + System.getProperty("bombip" , "127.0.0.1:9082") + "/bomb-1.0/", 
									"http://" + System.getProperty("collisionip" , "127.0.0.1:9082") + "/collision-1.0/"};
	...
	private String  callRest(String urlin) {
		CollectionCircuitBreakers breakers = (CollectionCircuitBreakers)context.getAttribute("CollectionCircuitBreakers");
		if (breakers == null)
		{
			breakers = new CollectionCircuitBreakers(3, 10000);
			context.setAttribute("CollectionCircuitBreakers", breakers);
		}
		
		return breakers.callRest(urlin);
	}	
}
